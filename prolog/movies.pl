...
acted_in('Natalie Portman', 'Black Swan').
acted_in('Vincent Cassel', 'Black Swan').
acted_in('Mila Kunis', 'Black Swan').
acted_in('Winona Ryder', 'Black Swan').
...
directed('Darren Aronofsky', 'Black Swan').
