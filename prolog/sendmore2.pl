...
solution(S,E,N,D,M,O,R,Y) :-
    ...
    dig(D), dig(E), sum_and_carry(Y, C1, D+E),
    dig(N), dig(R), sum_and_carry(E, C10, N+R+C1),
    dig(E), dig(O), sum_and_carry(N, C100, E+O+C10),
    dig(S), S>0, dig(M), M>0, sum_and_carry(O, M, S+M+C100),
